...
if __name__ == '__main__':
    ...
    path_dir = '/d1/scratch/Garden1/Data/data2016/Run2016B/SingleMuon/MINIAOD/03Feb2017_ver2-v2/'
	...
	if item.find('root') is not -1:
	    ...
	    cfgfile.write('process.GlobalTag.globaltag = \'80X_dataRun2_2016SeptRepro_v7\'\n')
	    ...
	    shfile.write('cd /u/user/salee/JetMet/CMSSW8026MEtXY/src/MetTools/MetPhiCorrections/test/Jobs\n')
