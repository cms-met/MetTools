...
#pragma omp parallel for
  ...
  for (int itree=0; itree<ntrees; ++itree) {
    ...
    if (itree==(ntrees-1) || tree.LeftIndices().size()==0 || tree.LeftIndices().front()==tree.RightIndices().front()) 
    {
      printf("root node is already terminal");
      break;
    }
