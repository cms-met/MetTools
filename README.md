...
The output file(s) contain the histograms and MEx,y profiles that are now parametrized. When the test job runs satisfactorily, run the cfg on crab on the data you want the produce the corrections for.
